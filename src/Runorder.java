...
//        OrderList.add(hardCoded3);
        ...
        order.setOrderID((cust.OrderList.size()+1));
        ...
        for(int i=0;i<cust.categoryList.size();i++){
       ...
       check = input.next();
        ...
        for(int i=0;i<cust.itemsList.size();i++){
           System.out.print("P000"+cust.itemsList.get(i).getId()+"\t\t\t"+cust.itemsList.get(i).getName()+"\n");
        ...
        for(int i = 0; i < cust.OrderList.size();i++){
            ...
            for(int j=0;j<cust.OrderList.get(i).getOrderedItems().size();j++){
                
                if(salesNo == cust.OrderList.get(i).getOrderedItems().get(j).getId()){
                    System.out.print(cust.OrderList.get(i).getCustID()+"\t\t\t");
                    System.out.print(cust.OrderList.get(i).getOrderedItems().get(j).getName()+"\t\t");
                    System.out.print(cust.OrderList.get(i).getOrderedItems().get(j).getPrice()+"\t\t\t");
                    System.out.print(cust.OrderList.get(i).getItemQuantity().get(j).intValue()+"\t\t");
                    double itemPrice = cust.OrderList.get(i).getOrderedItems().get(j).getPrice();
                    double quantity =  cust.OrderList.get(i).getItemQuantity().get(j).doubleValue();
