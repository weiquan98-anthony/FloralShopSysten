...
public class CatalogOrder {
   ...
   public CatalogOrder(){
    ...
    public CatalogOrder(int OrderID, int CustID, Timestamp orderTime, String DeliveryMethod, String orderStatus, Date deliveryDate, String deliveryTime, double subtotal
