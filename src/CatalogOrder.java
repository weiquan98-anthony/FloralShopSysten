...
public class CatalogOrder {
    ...
    public CatalogOrder(String OrderID, String StaffID, String CustID, Timestamp orderTime, LinkedList<Item> orderedItems, String DeliveryMethod,LinkedList<Integer> itemQuantity) {
